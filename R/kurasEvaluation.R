...
#' Anzahl an Indikatoren pro Effekt
#' 
#' @return data frame mit Spalten \emph{eID} (Effekt-ID), \emph{eName} (Effekt-Name),
...
.kuras.barplot <- function(values, names.arg, main) {
    graphics::barplot(height = values, names.arg = names.arg, 
        main = main, sub = .lastUpdate(), horiz = TRUE, las = 1, 
        cex.names = 0.8)
}
